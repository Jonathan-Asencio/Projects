...
/**
 * Class that simulates Battleship board game
 * 
 * @author Jonathan Asencio
 * @version 20190712
 */
public class BattleshipGame {
    private Armada myBoard;
     ...
     * @param filename
     */
    public BattleshipGame(GameClient client, Logger gameLogger, int current_player, String filename)
    {
        this.client = client;
        ...
        this.myBoard = new Armada(filename);
